...
export default class Basketball extends Component {
    state = {
        ...
        availableLivegames : [],
        rosters : [
          [{name: "Saint Bede Academy"}, {name: "Nathan Husser", number: 0}, {name: "Connor Brown", number: 1}, {name: "Brendan Pillion", number: 2}, {name: "Callan Hueneburg", number: 3}, {name: "John Brady", number: 4}, {name: "Isaiah Hart", number: 10}, {name: "Landon Jackson", number: 13}, {name: "Benedek Sotonyi", number: 15}, {name: "Alex Ankiewicz", number: 21}, {name: "Luke Tunnell", number: 22}, {name: "Evan Entrican", number: 23}, {name: "Dylan Hunter", number: 24}, {name: "Logan Potthoff", number: 25}, {name: "Tom Makransky", number: 30}, {name: "Joe Bima", number: 31}, {name: "Hayden Arkins", number: 32}, {name: "Sam Bima", number: 44}, {name: "Ali Arslan", number: 45}],
          [{name: "Marquette"}, {name: "Krew Bond", number: 12}, {name: "Griffin Walker", number: 13}, {name: "Alex Graham", number: 14}, {name: "Tommy Durdan", number: 15}, {name: "Logan Nelson", number: 20}, {name: "Carson Zellers", number: 21}, {name: "Henry McGrath", number: 22}, {name: "Tyler Waldron", number: 24}, {name: "Denver Trainor", number: 25}, {name: "Noah Barth", number: 30}, {name: "Charlie Mullen", number: 32}, {name: "Caden Eller", number: 33}, {name: "Daniel Hoffman", number: 34}, {name: "Peter McGrath", number: 35}] 
          ...
          [{name: "Mendota"}, {name: "Kaleb Kleckner", number: 1}, {name: "Isaac Guzman", number: 2}, {name: "Krew Bond", number: 3}, {name: "Ricky Orozco", number: 4}, {name: "Emilio Perez", number: 5}, {name: "Ted Landgraf", number: 10}, {name: "Rafael Romero", number: 11}, {name: "Dom Stamberger", number: 12}, {name: "Ryne Strouss", number: 13}, {name: "Ryan Stevenson", number: 22}, {name: "Logan Dewey", number: 23}, {name: "Mason Koch", number: 24}, {name: "Izaiah Nañez", number: 32}, {name: "Cale Strouss", number: 33}, {name: "Jose Rocha", number: 44}],
          ...
          [{name: "LaSalle-Peru"}, {name: "John Riva", number: 1}, {name: "Connor Noramczyk", number: 2}, {name: "Michael Jereb", number: 3}, {name: "Osvaldo Hernandez", number: 4}, {name: "Kaedyn Oberholz", number: 5}, {name: "London Cabrera", number: 12}, {name: "Tyler Wrobleski", number: 14}, {name: "Tommy Hartman", number: 20}, {name: "Josh Senica", number: 21}, {name: "Sean Whitfield", number: 22}, {name: "Dalton Znaniecki", number: 23}, {name: "Seth Adams", number: 30}, {name: "Tre'von Hunter", number: 31}, {name: "Wes Ruppert", number: 32}],
          ...
          [{name: "Midland"}, {name: "Brady Hattan", number: 1}, {name: "Riley McFadden", number: 2}, {name: "Owen LaRoe", number: 4}, {name: "Brett Smith", number: 10}, {name: "Jacob Spricer", number: 12}, {name: "T.J. Guthman", number: 13}, {name: "Trevin Meinders", number: 21}, {name: "Ben Collins", number: 23}, {name: "Ryan Bella", number: 24}, {name: "Billy Poignant", number: 33}, {name: "Ryan Riddell", number: 34}, {name: "Keagan Faulkner", number: 42}],
          ...
          [{name: "Lane Tech"}, {name: "Sean Molloy", number: 1}, {name: "Jack Tzur", number: 2}, {name: "Joseph Perona", number: 3}, {name: "Ethan Grunebaum", number: 5}, {name: "AJ Zanders", number: 10}, {name: "Karson Spencer", number: 11}, {name: "Hayden Matthews", number: 12}, {name: "Will Rosenkrantz", number: 13}, {name: "Parker Springer", number: 15}, {name: "Lorenzo Aquino", number: 20}, {name: "Tommy Stone", number: 21}, {name: "Shaheed Solebo", number: 22}, {name: "Stephen Goonan", number: 23}, {name: "Lucas Basille", number: 24}, {name: "Omar Abushalanfah", number: 32}, {name: "Giuliano DiFranco", number: 35}],
          [{name: "Whitney Young"}, {name: "AJ Casey", number: 0}, {name: "Ian Boyd", number: 1}, {name: "Addison Petrulis", number: 2}, {name: "Dalen Davis", number: 3}, {name: "Marcus Pigram", number: 4}, {name: "Xavier Amos", number: 5}, {name: "Kanye Smith", number: 10}, {name: "Daniel Johnson", number: 11}, {name: "Jordan Streeter", number: 13}, {name: "Sean Brown", number: 20}, {name: "Antonio Munoz", number: 21}, {name: "Kevin Iverson", number: 24}, {name: "Matthew Somerville", number: 25}, {name: "Marcus Overstreet", number: 33}],
          [{name: "Curie"}, {name: "Phoenix Bullock", number: 1}, {name: "Carlos Harris", number: 2}, {name: "Shawn Brown", number: 3}, {name: "Kros Barrett", number: 4}, {name: "Isaiah Pickens", number: 5}, {name: "Leslie Green", number: 10}, {name: "Marquise Davis", number: 12}, {name: "Rashaad Wilson", number: 15}, {name: "Taevion Collier", number: 21}, {name: "Chikasi Ofoma", number: 23}, {name: "Jeremy Harrington", number: 24}, {name: "Mason Minor", number: 30}, {name: "Amurion Hodges", number: 34}],
          [{name: "Gardner South Wilmington"}, {name: "Bryce Handzus", number: 2}, {name: "Ryan Cacello", number: 3}, {name: "Dane Halpin", number: 11}, {name: "Noah Wise", number: 12}, {name: "Glenn Torri", number: 13}, {name: "Cale Halpin", number: 14}, {name: "Ethan Mack", number: 15}, {name: "Brody Fatlan", number: 20}, {name: "Jacob Ozee", number: 21}, {name: "Keith Page", number: 23}, {name: "Garrett Grant", number: 25}, {name: "Bennett Grant", number: 30}, {name: "Alic Gill", number: 33}, {name: "Gabe McHugh", number: 34}, {name: "Trey Schweltzer", number: 42}]]
      }
