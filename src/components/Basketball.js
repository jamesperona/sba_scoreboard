...
export default class Basketball extends Component {
    state = {
        ...
        rosters : [
          ...
          [{name: "Putnam County"}, {name: "Owen Saepharn", number: 1}, {name: "Andrew Pyzska", number: 2}, {name: "Drake Smith", number: 3}, {name: "Blake Billups", number: 4}, {name: "Blake Baker", number: 5}, {name: "Austin Mattingly", number: 10}, {name: "Orlando Harris", number: 12}, {name: "Spencer Voss", number: 15}, {name: "Chad Olson", number: 21}, {name: "Lucas Wiesbrock", number: 22}, {name: "Jackson McDonald", number: 23}, {name: "Wyatt Grimshaw", number: 25}],
