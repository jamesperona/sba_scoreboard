...
export default class Basketball extends Component {
    state = {
        ...
        rosters : [
          ...
          [{name: "Earlville"}, {name: "Jeremy Weymouth", number: 0}, {name: "Diego Vazquez", number: 2}, {name: "Garrett Cook", number: 4}, {name: "Bryar Keller", number: 5}, {name: "Easton Fruit", number: 10}, {name: "Adam Waite", number: 12}, {name: "Matt Kuter", number: 13}, {name: "Trenton Fruit", number: 15}, {name: "Griffin Cook", number: 20}, {name: "Rocco Morsovillo", number: 23}, {name: "Ryan Browder", number: 24}]]
      }
