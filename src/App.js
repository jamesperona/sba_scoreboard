...
class App extends Component {
  state = {
    ...
    rosters : [
      ...
      [{name: "Mendota"}, {name: "Emiliano Arteaga", number: 1}, {name: "Chris Sandoval", number: 2}, {name: "Gavin Glazebrook", number: 3}, {name: "Jose Sandoval", number: 4}, {name: "Jae Shaun Hughes", number: 5}, {name: "Abraham Guzman", number: 10}, {name: "Cole Stremlau", number: 11}, {name: "Gabriel Guzman", number: 13}, {name: "Charles Kaufman", number: 14}, {name: "Jesus Bakr", number: 15}, {name: "Trent Stamberger", number: 24}, {name: "Alexis Quintana", number: 33}, {name: "Mauricio Escatel", number: 35}, {name: "Aaron Schmidt", number: 44}, {name: "Nick Rosales", number: 45}]]
  }
